...
export default async function AdminNotificationsPage() {
  ...
  const [{ data: categories }, configured] = await Promise.all([supabase.from("donation_categories").select("slug,name").eq("is_active", true).order("name"), isPushConfigured()]);
