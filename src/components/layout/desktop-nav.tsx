  ...
  return (
    <header className="sticky top-0 z-40 hidden border-b border-manta bg-papel/90 backdrop-blur md:block">
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-6">
        <Link href="/" className="font-display text-xl font-semibold text-anil-800">
          {t.app.name}
        </Link>
        <nav aria-label="Navegación principal" className="flex items-center gap-6">
          ...
          <Link
            href="/donar"
            className="rounded-full bg-cirio-500 px-5 py-2 text-sm font-semibold text-white hover:bg-cirio-600"
          >
            {t.nav.donate}
          </Link>
